<div>
    ...
    {{-- Esto tambien incluirlo dentro del foreach --}}
    ...
    {{-- En realida aquí termina el foreach pero sin incluir los dos <li> de arriba --}}
    </div>
    </div>
</div>
