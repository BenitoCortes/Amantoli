        ...
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-6 ">
            ...
            <form wire:submit.prevent="update">
                <div class="flex space-x-3 mt-2">
                    <x-jet-label>
                        <input type="radio" wire:model="status" name="status" value="2" class="mr-2">
                        PAGADO
                    </x-jet-label>
                    <x-jet-label>
                        <input type="radio" wire:model="status" name="status" value="3" class="mr-2">
                        ENVIADO
                    </x-jet-label>
                    <x-jet-label>
                        <input type="radio" wire:model="status" name="status" value="4" class="mr-2">
                        ENTREGADO
                    </x-jet-label>
                    <x-jet-label>
                        <input type="radio" wire:model="status" name="status" value="5" class="mr-2">
                        ANULADO
                    </x-jet-label>
                </div>
                <div class="flex mt-2">
