            ...
            <ul class="divide-y divide-gray-200">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-2 text-sm">
                        <a class="cursor-pointer hover:text-Orange-500 capitalize {{ $subcategoria == $subcategory->slug ? 'text-Orange-500 font-bold' : '' }}"
            ...
            <ul class="divide-y divide-gray-200">
                @foreach ($category->brands as $brand)
                    <li class="my-2 text-sm">
                        <a class="cursor-pointer hover:text-Orange-500 capitalize {{ $marca == $brand->name ? 'text-Orange-500 font-bold' : '' }}"
                            ...
                            <article>
                                <figure>
                                    <img class="h-48 w-full object-cover object-center"
                                        src="{{ Storage::url($product->images->first()->url) }}" alt="products">
                                </figure>
                                <div class="py-4 px-6">
                    ...
                    @empty
                        <li class="md:col-span-2 lg:col-span-4">
                            <div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3"
                                ...
                                <p class="text-sm">Por el momento no tenemos productos con esos filtros</p>
                            </div>
