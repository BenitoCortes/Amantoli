<div class="container py-12">
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            Formulario para registrar estados
        </x-slot>
        <x-slot name="form">
    ...
    <x-jet-action-section>
        ...
        <x-slot name="description">
            - Aquí encontrara todos los estados registrados
            <br>
            - Para agregar una o varias ciudades pulse sobre un estado de la tabla
        </x-slot>
        <x-slot name="content">
            <x-table-responsive>
                                ...
                                <td class="py-2">
                                    <div class="flex divide-x divide-gray-300">
                                        <a class="pr-2 hover:text-blue-700 cursor-pointer"
                                            wire:click="edit({{ $state }})">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a class="pl-2 hover:text-red-700 cursor-pointer"
                                            wire:click="$emit('deleteState',{{ $state->id }})">
            ...
            livewire.on('deleteState', stateId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        livewire.emitTo('admin.state-component', 'delete', stateId);
                        Swal.fire(
                            '¡Eliminado!',
