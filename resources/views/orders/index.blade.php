<x-app-layout>
    ...
    <div class="container py-12">
        <section class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 text-white">
            <a href="{{ route('orders.index') . '?status=1' }}"
                class="bg-gray-500 shadow-lg bg-opacity-85 rounded-lg px-12 pt-8 pb-4">
                        ...
                        <li class="">
                            <a href="{{ route('orders.show', $order) }}"
                                ...
                                <span>
                                    @switch($order->status)
                                        @case(1)
                                            <i class="fas fa-business-time text-gray-500 opacity-50">
